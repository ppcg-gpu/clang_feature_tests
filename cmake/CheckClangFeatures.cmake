...
function(check_clang_features)
  ...
  # Check for getImmediateExpansionRange vs getImmediateInstantiationRange
  check_cxx_source_compiles("
    #include <clang/Basic/SourceManager.h>
    int main() {
      using namespace clang;
  ...
  " HAVE_GETIMMEDIATEEXPANSIONRANGE)
  
  if(NOT HAVE_GETIMMEDIATEEXPANSIONRANGE)
    set(getImmediateExpansionRange "getImmediateInstantiationRange" PARENT_SCOPE)
  endif()

  # Check for DiagnosticsEngine vs Diagnostic (another way)
  check_cxx_source_compiles("
    #include <clang/Basic/Diagnostic.h>
    int main() {
      clang::DiagnosticsEngine* engine;
  ...
  if(NOT HAVE_DIAGNOSTICSENGINE)
    set(DiagnosticsEngine "Diagnostic" PARENT_SCOPE)
  endif()

  # Check for getNumParams vs getNumArgs and getParamType vs getArgType
  check_cxx_source_compiles("
    #include <clang/AST/CanonicalType.h>
    int main() {
      clang::FunctionProtoType* fpt;
      fpt->getNumParams();
      return 0;
    }
  " HAVE_GETNUMPARAMS)
  
  if(HAVE_GETNUMPARAMS)
    set(getNumArgs "getNumParams" PARENT_SCOPE)
    set(getArgType "getParamType" PARENT_SCOPE)
  endif()

  # Check for getReturnType vs getResultType in CanonicalType
  check_cxx_source_compiles("
    #include <clang/AST/CanonicalType.h>
    int main() {
      clang::FunctionProtoType* fpt;
  ...
  " HAVE_GETRETURNTYPE_CANONICAL)
  
  if(NOT HAVE_GETRETURNTYPE_CANONICAL)
    set(getReturnType "getResultType" PARENT_SCOPE)
  endif()
endfunction()
